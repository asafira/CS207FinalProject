...
*/
  ...
  /*
  DMat& PoissonIPDGbc2D( 
    DVec& ubc,        // [in]
    DVec& qbc);       // [in]
  */
  
  DVec& PoissonIPDGbc2D( 
    DVec& ubc,        // [in]
    DVec& qbc);       // [in]    
  ...
  void OutputTxt(const DMat& FData, int order, int zfield=0);
  void nodeDataOutput(const DMat& FData, int order, int zfield=0);
  void triDataOutput(const DMat& FData, int order, int zfield=0);
